...
@section('content')
    <div class="mb-8 border-b border-[#E5E3DB] pb-5">
        <a href="{{ route('classes.index') }}"
            class="text-xs uppercase tracking-[0.15em] text-slate-400 hover:text-[#A16207]">&larr; Daftar Kelas</a>
        <h1 class="font-display mt-2 text-3xl font-semibold text-[#16213A]">Ubah Kelas</h1>
        <p class="mt-1 text-sm text-slate-500">Memperbarui data untuk kelas <span
