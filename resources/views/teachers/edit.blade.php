...
@section('content')
    <div class="mb-8 border-b border-[#E5E3DB] pb-5">
        ...
        <h1 class="font-display mt-2 text-3xl font-semibold text-[#16213A]">Ubah Guru</h1>
        <p class="mt-1 text-sm text-slate-500">Memperbarui data untuk guru <span class="font-medium text-[#16213A]">{{ $teacher['name'] }}</span>.</p>
    </div>
