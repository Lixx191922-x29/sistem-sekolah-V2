...
@section('content')
    <div class="mb-8 border-b border-[#E5E3DB] pb-5">
        ...
        <p class="mt-1 text-sm text-slate-500">Isi data untuk menambahkan guru baru ke sistem.</p>
    </div>
    ...
    <form action="{{ route('teachers.store') }}" method="POST" class="space-y-6 border border-[#E5E3DB] bg-white p-8">
        ...
        <div class="flex justify-end gap-4 border-t border-[#EFEDE6] pt-6">
            ...
            <button type="submit"
                class="bg-[#16213A] px-6 py-2.5 text-sm font-medium text-white transition hover:bg-[#26324f]">Simpan Guru</button>
        </div>
    </form>
@endsection
